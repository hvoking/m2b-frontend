	...
	return (
		<div className="pictures-footer">
			<div className="pictures-footer-item">
				<img width="30px" height="20px" src="static/main/maps/pictures/bed.svg" alt="bed"/>
				<div>{rooms} dorm</div>
			</div>
			<div className="pictures-footer-item">
				<img width="30px" height="20px" src="static/main/maps/pictures/shower.svg" alt="shower"/>
				<div>{suites} {suites === 1 ? "suite" : "suites"}</div>
			</div>
			<div className="pictures-footer-item">
				<img width="30px" height="20px" src="static/main/maps/pictures/car.svg" alt="car"/>
				<div>{garages} {garages === 1 ? "vaga" : "vagas"}</div>
			</div>
			<div className="pictures-footer-item">
				<img width="30px" height="15px" src="static/main/maps/pictures/arrow.svg" alt="arrow"/>
				<div>{area} m² (útil)</div>
			</div>
		</div>
	)
